#ifndef DUST3D_APPLICATION_SHADOW_OPENGL_PROGRAM_H_
#define DUST3D_APPLICATION_SHADOW_OPENGL_PROGRAM_H_
...
class ShadowOpenGLProgram : public QOpenGLShaderProgram {
public:
