#ifndef DUST3D_APPLICATION_WORLD_OPENGL_PROGRAM_H_
#define DUST3D_APPLICATION_WORLD_OPENGL_PROGRAM_H_
...
class WorldOpenGLProgram : public QOpenGLShaderProgram {
public:
