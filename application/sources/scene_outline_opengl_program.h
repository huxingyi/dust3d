#ifndef DUST3D_APPLICATION_SCENE_OUTLINE_OPENGL_PROGRAM_H_
#define DUST3D_APPLICATION_SCENE_OUTLINE_OPENGL_PROGRAM_H_
...
class SceneOutlineOpenGLProgram : public QOpenGLShaderProgram {
public:
