#ifndef DUST3D_APPLICATION_WORLD_GROUND_OPENGL_PROGRAM_H_
#define DUST3D_APPLICATION_WORLD_GROUND_OPENGL_PROGRAM_H_
...
class WorldGroundOpenGLProgram : public QOpenGLShaderProgram {
public:
