...
HEADERS += sources/image_crop_widget.h
SOURCES += sources/image_crop_widget.cc
...
HEADERS += sources/turnaround_edit_widget.h
SOURCES += sources/turnaround_edit_widget.cc
