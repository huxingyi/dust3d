...
HEADERS += ../dust3d/animation/insect/forward.h
HEADERS += ../dust3d/animation/insect/attack.h
HEADERS += ../dust3d/animation/insect/die.h
HEADERS += ../dust3d/animation/bird/forward.h
...
HEADERS += ../dust3d/animation/fish/forward.h
HEADERS += ../dust3d/animation/snake/forward.h
...
SOURCES += ../dust3d/animation/snake/forward.cc
