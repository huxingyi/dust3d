...
SOURCES += sources/animation_manage_widget.cpp
...
HEADERS += ../dust3d/animation/fly/walk.h
HEADERS += ../dust3d/animation/fly/rub_hands.h
HEADERS += ../dust3d/animation/fly/forward.h
HEADERS += ../dust3d/animation/fly/attack.h
HEADERS += ../dust3d/mesh/base_normal.h
SOURCES += ../dust3d/animation/animation_generator.cc
SOURCES += ../dust3d/animation/fly/walk.cc
SOURCES += ../dust3d/animation/fly/rub_hands.cc
SOURCES += ../dust3d/animation/fly/forward.cc
SOURCES += ../dust3d/animation/fly/attack.cc
