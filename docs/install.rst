...
* For Windows:
    ...
    https://github.com/huxingyi/dust3d/releases/download/1.0.0-beta.29/dust3d-1.0.0-beta.29-x86.zip

    No need to install, unzip and run the exe.

* For Mac OS X:

    https://github.com/huxingyi/dust3d/releases/download/1.0.0-beta.29/dust3d-1.0.0-beta.29.dmg
...
* For Linux:
    ...
    https://github.com/huxingyi/dust3d/releases/download/1.0.0-beta.29/dust3d-1.0.0-beta.29-x86_64.AppImage

    .. code-block:: none

        $ chmod a+x ./dust3d-1.0.0-beta.29-x86_64.AppImage
        $ ./dust3d-1.0.0-beta.29-x86_64.AppImage
