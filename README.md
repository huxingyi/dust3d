...
From my initial thought, Dust3D should be a tool like [Makehuman](www.makehuman.org), with more versatile features, not only can make human, but also able to **generate monsters automatically**.
